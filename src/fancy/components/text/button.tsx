  ...
  },
  {
    ...
    component: ({ className, ...props }) => (
      <button
        {...props}
        className={cn(
          'animate-shine items-center justify-center rounded-xl border border-border bg-[#ff5840]',
          'px-4 py-2 text-white/90 transition-colors ',
...
return (
  <Button variant="shine" className='bg-[#ff5840]'>
    Button
  </Button>
)
}
